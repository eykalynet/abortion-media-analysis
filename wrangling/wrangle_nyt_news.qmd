...
# Join words with sentiment scores
nyt_sentiment <- nyt_words |> 
  left_join(afinn, by = "word")

# Summarize sentiment score per article
...
article_sentiment |> 
  ...
  geom_histogram(binwidth = 1, fill = "black", color = "skyblue") +
  labs(title = "Distribution of NYT Article Sentiment Scores", x = "Sentiment Score", y = "Number of Articles")
...
nyt_meta5 |> 
  ...
  labs(title = "Distribution of Sentiment Scores", x = "Sentiment Score", y = "Number of Articles")
