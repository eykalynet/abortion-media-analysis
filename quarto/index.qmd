...
While looking at the top bigrams helps us understand the key terms for 
both Fox New and NYT articles, we can further investigate the context with
which these terms are used. Below is a network of bigrams connected through 
the use of two bi-grams in the same article. 

Continuing with our analysis of changes pre and post the overturning of
*Roe v. Wade*, we look at the connections in bigrams and topics before and after
for both the NYT and Fox News. 
...
In Fox News articles, there are legal focal points centering the *Supreme Court* and *federal debate*, but also a high concentration of *faith* diven focs points and *moral arguments*. Moral argument, is the center to many pro-choice/pro-life articles, suggesting that the contention for or against abortion rights in Fox News centers around a moral argument. The is a heavy connection for pro-life to moral arguments, hence demonstrate pro-life as a main topic for discourse in fox news. 

In post-roe Fox News articles, we se a similar focus on the supreme court and pro-life, with the additional pro-life messaging and 
